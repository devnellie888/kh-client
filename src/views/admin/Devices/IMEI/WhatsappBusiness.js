...
import { getWhatsappBusiness } from "api/admin/requests";
import getLocalDate from "utils/getLocalDate";
import { PuffLoader } from "react-spinners";
import { sortById, sortByKey, sortByDate } from "utils/sorting";

const WhatsappBusiness = ({ imei }) => {
  ...
  }, [getWhatsappBusiness, imei, whatsapp.length]);

  const getWhatsapps = () => {
    getWhatsappBusiness({ imei, skip: whatsapp.length }, (data) => {
